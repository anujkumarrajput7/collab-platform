    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md shadow-2xl border-0 bg-white/95 backdrop-blur relative z-10">
        <CardHeader className="space-y-3 text-center pb-8">
          ...
          <CardDescription className="text-base">Sign in to continue your collaboration journey</CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col space-y-4 pt-6">
            <Button 
              type="submit" 
              className="w-full h-12 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold text-lg shadow-lg hover:shadow-xl transition-all" 
              disabled={isLoading}
            >
              {isLoading ? (
                <>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-white px-2 text-muted-foreground">New to Collab Platform?</span>
              </div>
            </div>
